...
def spotify_credentials() -> spotipy:
...
def get_playlist_data(playlist_uri: str) -> pd.DataFrame:
    ...
    for track in playlist:
        ...
        for artist in artists:
            ...
            artist_id = artist['id']
            track_artist_names.append(artist_name)
        ...
        tracks.append([track_id, track_uri, track_name, track_artist_names, track_artist_ids, track_popularity, track_explicit, track_duration_ms, track_album_name, track_album_uri])

        # Tracks DataFrame
        tracks_df_cols = ['track_id', 'track_uri', 'track_name', 'track_artist_ids', 'track_artist_ids', 'track_popularity', 'track_explicit', 'track_duration_ms', 'track_album_name', 'track_album_uri']
